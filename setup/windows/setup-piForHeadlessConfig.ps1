...
wget https://raw.githubusercontent.com/lndj/teslausb/main-dev/setup/windows/WpaSupplicantConf.psm1 -OutFile WpaSupplicantConf.psm1
wget https://raw.githubusercontent.com/lndj/teslausb/main-dev/setup/windows/add-wifi.ps1 -OutFile add-wifi.ps1
